...
tabAutomation:CreateToggle({
   ...
   Callback = function(state)
      ...
      if running then
         task.spawn(function()
            -- Caminho corrigido para o serviço de recompensa
            ...
            while running do
               -- Tenta coletar os IDs de 1 a 12 (padrão da maioria dos jogos)
               for i = 1, 12 do
